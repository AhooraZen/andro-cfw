...
3. Run the full unit test suite:
   ...
   ```
4. Verify code edits break 0 existing tests and maintain 100% pass rate across all 76 unit tests.

## 3. Release & PyPI Deployment Checklist
When preparing a new official release (e.g. `v0.3.0`):

1. **Bump Version**: Update `version` in both `pyproject.toml` and `andro_cfw/__init__.py`.
